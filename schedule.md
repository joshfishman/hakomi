...
<center>
   <h1 class="post-title">Hakomi House 2025 Schedule</h1>
    <h3>Hakomi House: Comprehensive Training Center and Home for Creating Community</h3>
    <h4><em>In celebration of The Ron Kurtz Refined Hakomi Method</em></h4>
    <h3>Presents</h3>
    <p>An on-going series of yearly Comprehensive Training</p>
    <h3>Beginning April 2025 </h3>
    ...
    <p>Complete 16 or 24 Dates for Certification</p>
    <h4>Inaugural Comprehensive Training Program Dates offered in 2025</h4>
</center>
<h4>3-day Weekend Training</h4>
<ul>
        <li>April 11th-13th</li>
        <li>May 9th-11th</li>
        <li>June 13th-15th</li>
        <li>July 11th-13th</li>
        <li>August 15, 16, 17</li>
        <li>September 12, 13, 14</li>
        <li>October 17, 18, 19</li>
        <li>November 14, 15, 16</li>
    </ul>
<em>(All Sessions 9:00 am to 6:00 pm)<br>Cost: $220 per day</em>
